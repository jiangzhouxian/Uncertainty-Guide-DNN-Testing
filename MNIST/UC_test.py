...
# read the parameter
# argument parsing
parser = argparse.ArgumentParser(description='Main function for uncertainty-guided inputs generation in MNIST dataset')
...
print("\n\n")
output_directory = './UC/uncertainty_generated_inputs_Model' + str(args.target_model + 1)+'/'
...
if no_valid == 0:
    ...
    print('Avg. test l2 distance: {} and {}'.format(total_l2/no_valid,total_perturb_adversial/no_valid))
